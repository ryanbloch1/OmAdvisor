...
public class RoundGraphIssuedSales extends LinearLayout {
    ...
    public RoundGraphIssuedSales(Context context) {
        super(context);
        init();
    }

    public RoundGraphIssuedSales(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }


    public RoundGraphIssuedSales(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        inflater.inflate(R.layout.widget_round_graph_issued_sales, this, true);
