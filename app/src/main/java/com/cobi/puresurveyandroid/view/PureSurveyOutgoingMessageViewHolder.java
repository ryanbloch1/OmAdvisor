...
public class PureSurveyOutgoingMessageViewHolder extends MessageHolders.OutcomingTextMessageViewHolder<IMessage> {

    private WebView webview;
    private FlexboxLayout bubble;

    public PureSurveyOutgoingMessageViewHolder(final View itemView) {
        super(itemView);
    ...
    private String getStyledFont(String html) {
        ...
        return "<style type=\"text/css\">@font-face {font-family: MontserratLight;" +
                ...
                "body {font-family: MontserratLight;font-size: light;text-align: justify; color: #000000;}</style>" +
