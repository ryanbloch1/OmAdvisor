...
public class IntentIntegrator {
    ...
    private static final String TAG = com.cobi.puresurveyandroid.util.IntentIntegrator.class.getSimpleName();
     ...
     */
    public com.cobi.puresurveyandroid.util.IntentIntegrator setCaptureActivity(Class<?> captureActivity) {
     ...
     *                 of an {@link Activity}
     */
    public static com.cobi.puresurveyandroid.util.IntentIntegrator forSupportFragment(androidx.fragment.app.Fragment fragment) {
        com.cobi.puresurveyandroid.util.IntentIntegrator integrator = new com.cobi.puresurveyandroid.util.IntentIntegrator(fragment.getActivity());
    ...
    public static com.cobi.puresurveyandroid.util.IntentIntegrator forFragment(Fragment fragment) {
        com.cobi.puresurveyandroid.util.IntentIntegrator integrator = new com.cobi.puresurveyandroid.util.IntentIntegrator(fragment.getActivity());
    ...
    public final com.cobi.puresurveyandroid.util.IntentIntegrator addExtra(String key, Object value) {
     ...
     */
    public final com.cobi.puresurveyandroid.util.IntentIntegrator setPrompt(String prompt) {
        if (prompt != null) {
     ...
     */
    public com.cobi.puresurveyandroid.util.IntentIntegrator setOrientationLocked(boolean locked) {
     ...
     * @return this
     */
    public com.cobi.puresurveyandroid.util.IntentIntegrator setCameraId(int cameraId) {
        if (cameraId >= 0) {
     ...
     * @return this
     */
    public com.cobi.puresurveyandroid.util.IntentIntegrator setBeepEnabled(boolean enabled) {
     ...
     * @return this
     */
    public com.cobi.puresurveyandroid.util.IntentIntegrator setBarcodeImageEnabled(boolean enabled) {
     ...
     * @return this
     */
    public com.cobi.puresurveyandroid.util.IntentIntegrator setDesiredBarcodeFormats(Collection<String> desiredBarcodeFormats) {
     ...
     * else an {@link com.cobi.puresurveyandroid.util.IntentResult} containing the result of the scan. If the user cancelled scanning,
     * the fields will be null.
     */
    public static com.cobi.puresurveyandroid.util.IntentResult parseActivityResult(int requestCode, int resultCode, Intent intent) {
        if (requestCode == REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                return new com.cobi.puresurveyandroid.util.IntentResult(contents,
                        formatName,
                        rawBytes,
                        orientation,
