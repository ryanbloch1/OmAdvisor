...
import com.cobi.puresurveyandroid.databinding.ActivityTandcBinding;
...
public class TandCActivity extends BaseActivity {
    ...
    ActivityTandcBinding mBinding;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_tandc);

        showFragment(R.id.fragment_container, new TermsConditionsFragment());
